...
def print_results(results_dic, results_stats, model, 
    ...
    #for key in results_stats:
        ...
        #
    print("{:30}: {}".format('% Correct Dogs', results_stats['pct_correct_dogs']))
    print("{:30}: {}".format('% Correct Breed', results_stats['pct_correct_breed']))
    print("{:30}: {}".format('% Correct "Not-a" Dog', results_stats['pct_correct_notdogs']))
    print("{:30}: {}".format('% Match', results_stats['pct_match']))
